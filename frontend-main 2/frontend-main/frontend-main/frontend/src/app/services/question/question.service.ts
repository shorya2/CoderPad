...
export class QuestionService {
  private quesUrl = 'http://localhost:8081/api/questions';
  private testUrl = 'http://localhost:8081/api/tests';
  ...
  updateQuestion(id: string, questionData: any): Observable<any> {
    return this.http.put(`${this.quesUrl}/${id}`, questionData);
  }
  ...
  addQuestionToTest(testId: string, questionId: string): Observable<any> {
    return this.http.post(`${this.testUrl}/${testId}/add-question/${questionId}`, {});
  }
